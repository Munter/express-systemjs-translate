...
var systemJsGlobals = {};
var globalSnapshotBeforeRequire;
...
module.exports = function systemJsTranslate(serverRoot, options) {
  ...
  globalSnapshotBeforeRequire = globalSnapshotBeforeRequire || Object.assign({}, global);
  try {
...
console.log('cleanUpGlobalLeaks: cleaning up leaked', key);
          delete global[key];
        });
      }
      ...
      builderPromise
        ...
        .then(cleanUpGlobalLeaks, function (err) {
